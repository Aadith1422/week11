...
### 2. Dyn DNS (2016)
- **Attack:** Mirai botnet used IoT devices to launch massive DDoS.  
- **Impact:** Twitter, Netflix, Reddit, Spotify inaccessible across US/EU.  
...
- **Impact:** AWS services briefly affected.  
...
- ⚖️ **National Security Risks:** State-sponsored DDoS can cripple infrastructure.  
